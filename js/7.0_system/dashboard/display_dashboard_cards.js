...
const MODULE_CARDS = [
    ...
    },
    {
        ...
        desc: "Compose and manage responses to challenge questions.",
    },
    {
...
function renderDashboardCards() {
    ...
    if (!cardsContainer) {
        console.warn("[display_dashboard_cards] #admin-cards not found — card rendering skipped.");
        return;
    }
...
function buildCardElement(card, index) {
    ...
    // The 10th card (System — index 9) is centered on the bottom row
    if (index === 9) {
    ...
    cardEl.addEventListener("click", () => {
        if (typeof window.loadModule === "function") {
            ...
            console.warn("[display_dashboard_cards] window.loadModule not available — card click ignored.");
        }
    });
