...
class RateLimiterMiddleware(BaseHTTPMiddleware):
    ...
    async def dispatch(self, request: Request, call_next):
        ...
        if forwarded:
            ...
            # This is where the 'NoneType' crash happened.
            # We check if client exists first.
            ip_address = (
        ...
        # If the dictionary is getting large, purge old entries
        # to prevent memory growth.
        if len(request_counts) > 10000:
            expired_ips = [
                ip for ip, (cnt, t) in request_counts.items() if now - t > 3600
            ]
        ...
        if ip_address not in request_counts:
            ...
            if now - first_request_time > 60:
                ...
                if count >= self.requests_per_minute:
                    ...
                    # Starlette's BaseHTTPMiddleware can struggle
