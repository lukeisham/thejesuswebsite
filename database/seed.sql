...
INSERT OR IGNORE INTO maps (map_key, map_name, description, image_path) VALUES
  ...
  ('jerusalem',    'Jerusalem',   'A first-century plan of Jerusalem showing the Temple Mount, First and Second Walls, Kidron and Hinnom Valleys, Mount of Olives, and the districts of the Upper City, Lower City, and City of David.', '/assets/images/maps/jerusalem.svg?v=3');
