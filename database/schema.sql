...
-- Composite index for getTopPagesWithTrend()'s per-page date-range JOIN
-- (see database/migrations/029_analytics_composite_index.sql).
CREATE INDEX idx_analytics_page_visited_at ON analytics (page, visited_at);
