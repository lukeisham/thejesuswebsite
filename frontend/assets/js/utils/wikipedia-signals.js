...
export const SIGNAL_DICTIONARY = [
  ...
  { key: 'bible_verses', name: 'Bible verses', capMagnitude: 9, polarity: 'positive' },
  { key: 'manuscripts', name: 'Manuscript mentions', capMagnitude: 6, polarity: 'positive' },
  { key: 'ante_nicene', name: 'Ante-Nicene author mentions', capMagnitude: 6, polarity: 'positive' },
  ...
  { key: 'jewish_context', name: 'Jewish context', capMagnitude: 4, polarity: 'positive' },
  { key: 'narrative_interp_split', name: 'Narrative/interpretation split', capMagnitude: 3, polarity: 'positive' },
  { key: 'location_bonus', name: 'Location bonus', capMagnitude: 3, polarity: 'positive' },
  { key: 'commentaries', name: 'Commentary citations', capMagnitude: 3, polarity: 'positive' },
  { key: 'ancient_historians', name: 'Ancient historian mentions', capMagnitude: 3, polarity: 'positive' },
  { key: 'arch_site', name: 'Archaeological site/artefact', capMagnitude: 2, polarity: 'positive' },
  { key: 'historical_context', name: 'Historical context', capMagnitude: 2, polarity: 'positive' },
  { key: 'wiki_quality', name: 'Wikipedia quality rating', capMagnitude: 1, polarity: 'positive' },
  { key: 'manuscript_bonus', name: 'Manuscript-title bonus', capMagnitude: 1, polarity: 'positive' },
  { key: 'niche_bonus', name: 'Niche topic bonus', capMagnitude: 1, polarity: 'positive' },

  // ─── Negative signals, largest penalty magnitude first ─────────────────────
  { key: 'no_bible_verse', name: 'No Bible verses', capMagnitude: 10, polarity: 'negative' },
  { key: 'mythicist', name: 'Mythicist citations', capMagnitude: 9, polarity: 'negative' },
  { key: 'no_references', name: 'No references', capMagnitude: 8, polarity: 'negative' },
  { key: 'jesus_seminar', name: 'Jesus Seminar citations', capMagnitude: 6, polarity: 'negative' },
  { key: 'ot_nt_criticism', name: 'OT–NT criticism', capMagnitude: 6, polarity: 'negative' },
  { key: 'supernatural_criticism', name: 'Supernatural criticism', capMagnitude: 6, polarity: 'negative' },
