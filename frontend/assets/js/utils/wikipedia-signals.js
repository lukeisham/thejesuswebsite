...
export const SIGNAL_DICTIONARY = [
  ...
  // narrative_interp_split is bidirectional (+10/-3/-5/0, §9 row 3) — listed under 'positive'
  // since its best-case magnitude dominates; a negative contribution here still renders correctly
  // via buildStatement()'s sign-agnostic ratio math, it just reads as "partial credit" rather than
  // "penalty" in the -3/-5 cases. A dedicated bidirectional polarity is a possible follow-up.
