...
function renderSingleRecord() {
    ...
    if (!slug) {
        ...
        descEl.innerHTML = "<p>A valid record identifier (slug) is required in the URL.</p>";
        return;
    }
    ...
    if (!record) {
        ...
        descEl.innerHTML = "<p>We could not find a record matching this identifier.</p>";
        return;
    }
    ...
    if (metadataItems.length > 0) {
        metaGrid.innerHTML = metadataItems.map(item => `
