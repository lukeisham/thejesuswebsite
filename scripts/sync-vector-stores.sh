...
#      "setup/Wikipedia algorithm v2/vector-stores/" (dev-machine only).
...
LOCAL_STORES_DIR="$PROJECT_DIR/setup/Wikipedia algorithm v2/vector-stores"
LOCAL_MODEL_DIR="$PROJECT_DIR/setup/Wikipedia algorithm v2/classifier/model"
