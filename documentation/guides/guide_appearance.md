...
| **Login Buttons** | `.login-box button` | Explicitly sharp-cornered, high-contrast action buttons used exclusively in the Admin Portal login sequence. | `css/design_layouts/views/login_view.css` |
