/*!
 * Vendored ESM bundle of nspell@2.1.5 (MIT), built for this project with
 * `esbuild --bundle --format=esm --platform=browser` from an entry module
 * re-exporting nspell's default export. Source: https://github.com/wooorm/nspell
 * Do not hand-edit — regenerate from npm if nspell needs to be upgraded.
 */
...
var entry_default = import_nspell.default;
export {
