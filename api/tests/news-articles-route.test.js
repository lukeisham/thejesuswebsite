// News Articles route tests — uses node:test + node:assert.
...
function createApp() {
  ...
  const routePath = require.resolve("../routes/news-articles");
