...
const WRITABLE_COLUMNS = [
  ...
  "challenge_body",
  "challenge_picture",
  "challenge_picture_alt",
  "challenge_picture_caption",
...
function normalizeForPublic(row) {
  ...
  return {
    ...
    challenge_picture_alt: row.challenge_picture_alt,
    challenge_picture_caption: row.challenge_picture_caption,
...
function getAllPublished(filters = {}) {
  ...
  return paginate(db, itemsSql, countSql, ["popular"], { page, limit });
}

/**
 * All popular challenges for the admin list — both draft and published,
